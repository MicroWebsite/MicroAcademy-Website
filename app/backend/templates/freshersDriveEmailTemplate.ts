export function buildFreshersDriveEmailHtml(data: {
  firstName: string;
  lastName: string;
  email: string;
  phone: string;
                ...
                <tr>
                  <td style="background-color: #6A5F00; padding: 48px 40px; text-align: left;">
                    <table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td>
                          <div style="color: #FBE426; font-size: 12px; font-weight: 800; text-transform: uppercase; letter-spacing: 2.4px; margin-bottom: 12px;">NEW REGISTRATION</div>
                          <h1 style="color: #ffffff; margin: 0; font-size: 32px; font-weight: 800; letter-spacing: -0.5px; line-height: 1.2;">Drive Registration</h1>
                        </td>
                ...
                <tr>
                  <td style="padding: 48px 40px;">
                    ...
                    <div style="margin-bottom: 40px; padding: 24px; background-color: #F9F8F3; border-radius: 16px; border-left: 4px solid #FBE426;">
                      <div style="color: #666; font-size: 12px; font-weight: 600; text-transform: uppercase; letter-spacing: 1px; margin-bottom: 4px;">REGISTERED DOMAIN</div>
                      <div style="color: #6A5F00; font-size: 20px; font-weight: 800;">${data.domain}</div>
                    </div>
                    ...
                    <table width="100%" border="0" cellspacing="0" cellpadding="0" style="margin-bottom: 40px;">
                      <tr>
                        <td style="padding: 12px 0; border-bottom: 1px solid #EEEEEE;">
                          ...
                          <div style="color: #1B1C19; font-size: 15px; font-weight: 600;">${data.firstName} ${data.lastName}</div>
                        </td>
                      </tr>
                      <tr>
