...
const socialLinks = [
  { label: 'Instagram', href: 'https://instagram.com/microacademy', icon: 'insta' },
  { label: 'Facebook', href: 'https://facebook.com/microacademy', icon: 'facebook' },
  { label: 'LinkedIn', href: 'https://linkedin.com/company/microacademy', icon: 'linkedin' },
];
