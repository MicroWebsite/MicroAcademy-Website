...
export type CareerFormErrors = Record<string, string>;
...
type ApplicationFormFieldsProps = {
  ...
  onChange: (field: keyof CareerFormData, value: string) => void;
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-1">
        ...
        {errors.resume && (
          <span className="text-[10px] text-red-500 font-manrope font-semibold">
            {errors.resume}
          </span>
        )}
      </div>
