    ...
    <section className={`w-full px-4 md:px-8 py-12 md:py-16 ${styles.section}`}>
      ...
      >
        ...
        <div className="relative z-10 flex flex-col items-center gap-6">
          <h2
            className={`text-center text-xl sm:text-2xl md:text-3xl font-bold font-manrope ${styles.title}`}
          >
            {title}
          </h2>
          <div className="max-w-[600px]">
            <p
              className={`text-center text-base md:text-lg leading-7 md:leading-8 font-manrope ${styles.description}`}
            >
              {description}
            </p>
          </div>
