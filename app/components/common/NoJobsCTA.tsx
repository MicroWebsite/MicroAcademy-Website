...
export default function NoJobsCTA({
  ...
  description = "Our recruitment drives are highly sought after and fill up quickly. Get in touch with us and we will get back to you as soon as the next window opens.",
