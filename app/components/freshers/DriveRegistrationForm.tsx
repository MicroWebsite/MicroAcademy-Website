...
import { validateEmail, validatePhone, validateRequired, validateFile } from '@/app/utils/validation';
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-8">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className={`w-full px-5 py-4 rounded-xl bg-[#F5F4EE] border outline-none transition-all ${
                errors.firstName ? 'border-red-500 bg-red-50' : 'border-[#E2E0D4] focus:border-[#6A5F00]'
              }`}
            />
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full px-5 py-4 rounded-xl bg-[#F5F4EE] border outline-none transition-all ${
                errors.lastName ? 'border-red-500 bg-red-50' : 'border-[#E2E0D4] focus:border-[#6A5F00]'
              }`}
            />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full px-5 py-4 rounded-xl bg-[#F5F4EE] border outline-none transition-all ${
                errors.email ? 'border-red-500 bg-red-50' : 'border-[#E2E0D4] focus:border-[#6A5F00]'
              }`}
            />
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              onChange={handleInputChange}
              className={`w-full px-5 py-4 rounded-xl bg-[#F5F4EE] border outline-none transition-all ${
                errors.phone ? 'border-red-500 bg-red-50' : 'border-[#E2E0D4] focus:border-[#6A5F00]'
              }`}
            />
        ...
        <div className="flex flex-col gap-2">
           ...
           <div 
             ...
             className={`w-full border-2 border-dashed rounded-2xl p-10 flex flex-col items-center justify-center gap-4 cursor-pointer transition-all ${
               errors.resume ? 'border-red-500 bg-red-50' : 'border-[#E2E0D4] bg-[#F9F9F7] hover:border-[#6A5F00]'
             }`}
           >
             <input 
               type="file" 
