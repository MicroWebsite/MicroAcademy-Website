    ...
    <section className="w-full bg-bg-cream px-8 py-24">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row gap-16 items-center">
        <div className="flex-1 flex flex-col gap-6">
          ...
          <p className="text-lg max-w-125 text-text-muted-alt font-manrope">
        ...
        <div className="flex-1 relative w-full flex justify-center">
          <div className="relative w-full max-w-125 aspect-4/5 overflow-hidden rounded-2xl shadow-[0px_24px_40px_-10px_rgba(0,0,0,0.1)]">
            <Image
              src="/assets/service/contract-hiring.png"
              alt="Contract Hiring Process"
              fill
