      ...
      <div className="max-w-[1216px] mx-auto flex flex-col gap-10">
        <div className="flex flex-col lg:flex-row gap-5 items-start">
          <motion.div
            ...
            viewport={{ once: true }}
            className="w-full lg:w-[32%] bg-linear-to-br from-primary to-secondary rounded-2xl p-8 text-white h-auto self-stretch"
          >
          ...
          <div className="w-full lg:w-[68%] flex flex-col pt-2">
            <motion.div
            ...
            <div className="grid sm:grid-cols-2 gap-5 w-full">
              {recruitmentSources.slice(0, 4).map((source, index) => (
                <motion.div
                  key={source.title}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 w-full">
          {recruitmentSources.slice(4).map((source, index) => (
            <motion.div
              key={source.title}
              initial={{ opacity: 0, y: 16 }}
              whileInView={{ opacity: 1, y: 0 }}
