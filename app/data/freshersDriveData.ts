...
export const freshersDrives: DriveDomain[] = [
  {
    ...
    description:
      "Architecting the future of data infrastructure. Join a world-class IT service provider through our curated Train & Hire model.",
    image:
  ...
  },
  {
    ...
    description:
      "Cloud Infrastructure Services (CIS) is the backbone of modern enterprise. Be part of the team managing large scale IT environments.",
    image:
      "https://images.unsplash.com/photo-1597733336794-12d05021d510?q=80&w=2000&auto=format&fit=crop",
    eligibility: {
      academicYear: "2023 and 2024 batch pass outs",
